...
import (
	...
	harbor "github.com/crossplane/provider-harbor/internal/controller"
	"github.com/crossplane/provider-harbor/internal/features"
)

func main() {
	var (
		app            = kingpin.New(filepath.Base(os.Args[0]), "Harbor support for Crossplane.").DefaultEnvars()
	...
	kingpin.FatalIfError(harbor.Setup(mgr, o), "Cannot setup Harbor controllers")
